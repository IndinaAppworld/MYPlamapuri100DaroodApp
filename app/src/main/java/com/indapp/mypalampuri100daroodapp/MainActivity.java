...
public class MainActivity extends Activity {
    ...
    {
        for(int i=0;i<Constants.URDU_NUMBERS.length;i++)
        {
            ...
            txtTitle1.setText("درود شریف "+Constants.URDU_NUMBERS[i]);
...
//                    String path = getExternalFilesDir(Environment.DIRECTORY_DOCUMENTS)+"/shareimage.png";
//                    java.io.OutputStream out = null;
//                    java.io.File file=new java.io.File(path);
//                    try { out = new java.io.FileOutputStream(file); bitmap.compress(Bitmap.CompressFormat.JPEG, 80, out); out.flush(); out.close(); } catch (Exception e) { e.printStackTrace(); }
//                    path=file.getPath();
//                    Log.v("Darood App---->","Path--->"+path);
